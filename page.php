        ...
        ?>
          <div class="col-xl-8 col-lg-12">
            <p class="mb-5">
                ...
                <!-- <img src="images/img_bg_1.jpg" alt="Free Bootstrap 4 Template by uicookies.com" class="img-fluid"> -->
            </p>
          ...
          <?php 
                $services = get_field('services_associees');
                // echo '<pre>';
                // print_r($services);
                // echo '</pre>';
            ...
            <?php
                ...
                if ( $the_query->have_posts() ) {
                    while ( $the_query->have_posts() ) {
                        ...
                        $classIcon == false ? $classIcon = 'oi-thumb-up' : get_field('classe_de_licone');
            ?> 
            <div class="col-lg-4 col-md-6">
                <div class="media d-block mb-4 text-left probootstrap-media p-md-5 p-4">
                  <div class="probootstrap-icon mb-3"><span class="oi <?= $classIcon ?> display-4"></span></div>
